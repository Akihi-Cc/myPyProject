...
print("【2】 Python 使用 ElementTree 解析 xml *******************************************")
...
price = book_elements[0].attrib['price']
...
print("【4】 Python 使用xml.dom 解析xml *******************************************")
