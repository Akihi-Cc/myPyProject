...
miles = 1000.0  # 浮点型变量
name = "runoob"  # 字符串
print(f"整形变量为：{counter}")
print(f"浮点型变量为：{miles}")
print(f"字符串变量为：{name}")
...
a = 111
print(isinstance(a, int))  # isinstance 在java  中 instanceof
...
print(f"str1 = {str1}")  # 打印整个字符串
print(f"str1[0:-1] = {str1[0:-1]}")  # 打印字符串第一个到倒数第二个字符（不包含倒数第一个字符）
print(f"str1[0] = {str1[0]}")  # 打印字符串的第一个字符
print(f"str1[2:5] = {str1[2:5]}")  # 打印字符串第三到第五个字符（包含第五个字符）
print(f"str1[2:] = {str1[2:]}")  # 打印字符串从第三个字符开始到末尾
print(f"str1 * 2 = {str1 * 2}")  # 打印字符串两次
print(f'str1 + "TEST" = {str1 + "TEST"}')  # 打印字符串和"TEST"拼接在一起
...
print("*******************************************【6】 List（列表） *******************************************")
# List（列表） 是 Python 中使用最频繁的数据类型。  等同于java中的list   写法  同  java数组
...
print(f"tuple:{tuple}")  # 输出完整元组
print(f"tuple[0]:{tuple[0]}")  # 输出元组的第一个元素
print(f"tuple[1:3]:{tuple[1:3]}")  # 输出从第二个元素开始到第三个元素
print(f"tuple[2:]:{tuple[2:]}")  # 输出从第三个元素开始的所有元素
print(f"tinytuple * 2:{tinytuple * 2}")  # 输出两次元组
print(f"tuple + tinytuple:{tuple + tinytuple}")  # 连接元组
# 元组与字符串类似，可以被索引且下标索引从0开始，-1 为从末尾开始的位置。也可以进行截取（看上面，这里不再赘述）。
# 其实，可以把字符串看作一种特殊的元组。
tup = (1, 2, 3, 4, 5, 6)
print(f"tup:{tup}")
print(f"tup[0]:{tup[0]}")
print(f"tup[1:5]:{tup[1:5]}")
...
print(f"sites:{sites}")  # 输出集合，重复的元素被自动去掉
# 成员测试
if 'Runoob' in sites:
    print('Runoob 在集合中')
else:
...
print("*******************************************【9】 Dictionary（字典） *******************************************")
# 字典（dictionary）是Python中另一个非常有用的内置数据类型。 等同与java  map
...
print("()表示 Tuple（元组）")
print("空元组 tuple = () ")
print("一个元素，需要在元素后添加逗号 tup2 = (20,)")

print("[]表示 List（列表")
print("空list list = []")

print("{}表示 Set（集合）")
print("空set set = set() ")  # {} 表示空字典 而非空set
...
print("可变数据（3 个）：List（列表）、Dictionary（字典）、Set（集合）。")
